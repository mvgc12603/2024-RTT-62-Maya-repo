...
public class EmployeeDAO {
    ...
    public Employee findById(Integer id) {
        ...
        // this is similar to the prepared statement, sets value in the query :firstname
        // to value passed into function
        query.setParameter("id", id);

        // we know we are querying a PK so the result will either be one or none
